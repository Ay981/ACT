...
export default function Maintenance() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-background flex flex-col items-center justify-center p-4">
      <div className="bg-white dark:bg-card p-8 rounded-3xl shadow-xl max-w-md text-center border border-slate-100 dark:border-border">
        ...
        <h1 className="text-2xl font-bold text-slate-900 dark:text-foreground mb-2">Under Maintenance</h1>
        ...
        <p className="text-sm text-slate-400 dark:text-muted-foreground">Please check back shortly.</p>
